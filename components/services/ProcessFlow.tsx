...
/** Compact horizontal stepper showing how a project moves from inquiry to delivery. */
export default function ProcessFlow() {
  return (
    <div className="relative">
      ...
      <StaggerGroup className="grid gap-8 sm:grid-cols-2 lg:grid-cols-6 lg:gap-4" amount={0.25}>
